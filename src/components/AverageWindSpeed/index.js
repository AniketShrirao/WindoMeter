            ...
            <Wrapper>
                ...
                <div className="search-details">
                    <form action="post" onSubmit={(e) => onAvgWindSpeedDetailsSubmit(e)}>
                        ...
                        <div className='form-inline-group'>
                            <FormGroup className="form-group">
                                <Dropdown options={directionsOptions} placeholder='direction from...' />
                            </FormGroup>
                            <FormGroup className="form-group">
                                <Dropdown options={directionsOptions} placeholder='direction to...' />
                            </FormGroup>
                        </div>
                        <FormGroup className="form-group">
                            <Dropdown options={directionsOptions} placeholder='district...' />
                        </FormGroup>
